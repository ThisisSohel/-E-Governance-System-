...
<head>
    ...
    <link rel="stylesheet" href="/css/lab_dashboard_patient_logged_in.css">
    ...
    <header class="head"> 
        ...
        <div class="biller-info-container">
            ...
            <div class="biller-profile-info">
                ...
                <b>Name:</b><span>{{$lab_officer->name}}</span><br>
                <b>P_ID:</b><span>{{$lab_officer->pid}}</span>
        ...
        <div class="patient-history-container">
            ...
            <div id="default-medical-history" style="text-align: center">
                @foreach ($test_array as $el)
                    ---------------------
                    <p>
                        <span style="color:rgb(0, 110, 255)">Test name:</span>{{$el->test_name}} <br>
                        <span style="color:rgb(0, 110, 255)">Reference Number:</span>{{$el->reference_num}}
                    </p>
...
function addTest(){
    if(document.getElementById("test-container").innerHTML.trim().length){
        ...
        node.insertAdjacentHTML('beforeend', '<div id="test-container"><div><label for="test">Test</label><input onchange="test_validation(this)" autocomplete="off" type="text" list="test_list" name="test" id="test"><label for="reference">Reference Number</label><input type="text" autocomplete="off" name="reference" id="reference" required><label for="report">Upload report</label><input type="file" name="report" id="report" required></div>');
    }
    else{
        var node = document.getElementById('test-container');
